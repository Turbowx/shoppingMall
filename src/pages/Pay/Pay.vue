  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a @click="payment" class="btn">立即支付</a>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="zhifu">支 付</el-button>
...
export default {
  ...
  methods: {
    //获取交易信息
    // async getOrderInfo() {
    //   let res = await this.$API.reqOrderInfo(this.orderId);
    //   if (res.code == 200) {
    //     console.log("获取交易信息", res);
    ...
    async payment() {
      ...
      if(!this.timer){
        this.timer = setInterval(async ()=>{
          let res = await this.$API.reqGetpaying();
    ...
    async zhifu(){
      ...
      let res = await this.$API.reqGetpaySuccess();
      console.log("支付状态",res);
      setTimeout(()=>{
        if(res.code == 200){
          clearInterval(this.timer);
