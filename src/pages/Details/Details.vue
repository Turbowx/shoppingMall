        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="Attrs in spuSaleAttrList" :key="Attrs.id">
                <dt class="title">选择{{ Attrs.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: attr.isChecked == 1 }"
                  v-for="attr in Attrs.spuSaleAttrValueList"
                  :key="attr.id"
                  @click="changeAttr(attr, Attrs.spuSaleAttrValueList)"
                >
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getDetailsData", this.$route.params.skuid);
  },
  methods: {
    //选择属性
    changeAttr(attr, arr) {
